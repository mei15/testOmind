        ...
        <div class="col-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 mb-4 header-title">Tambah Penjagaan</h4>
                    ...
                    <form action="{{ route('tempat.store') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name='user' id="user" value="{{ $user->userable->name }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Nama Tempat</label>
                            <div class="col-sm-10">
